...
export const OFFICIAL_URL = 'https://chat.tsui-space.com/';
export const OFFICIAL_PREVIEW_URL = 'https://chat-preview.tsui.space.com/';
export const OFFICIAL_SITE = 'https://tsuihub.com/';
...
export const DOCUMENTS_REFER_URL = `https://www.yuque.com/crd125/mip8xl/ggorvq2chkcuvgbn?singleDoc# 《Tsui-Chat使用文档》`;
